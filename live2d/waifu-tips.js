...
class c {
    ...
    set modelId(e) {
        this._modelId = e,
        localStorage.setItem("modelId", e.toString())
    }
    get modelId() {
        ...
        if (this.loading)
            ...
            try {
                ...
                if (2 === o) {
                    ...
                    3 === this.currentModelVersion && (this.cubism5model.release(),
                    this.resetCanvas()),
                    3 !== this.currentModelVersion && this.cubism2model.gl ? await this.cubism2model.changeModelWithJSON(e, t) : await this.cubism2model.init("live2d", e, t)
                } else {
                    if (!this.cubism5Path)
                    ...
                    2 === this.currentModelVersion && (this.cubism2model.destroy(),
                    this.resetCanvas()),
                    2 !== this.currentModelVersion && this.cubism5model.subdelegates.at(0) ? this.cubism5model.changeModel(e) : (this.cubism5model.initialize(),
    ...
    async loadNextModel() {
        ...
        this.useCDN ? (this.modelId = (this.modelId + 1) % this.modelList.models.length,
        await this.loadModel(this.modelList.messages[this.modelId])) : (this.modelId = (this.modelId + 1) % this.models.length,
        ...
        this.tools = {
            ...
            quit: {
                ...
                callback: () => {
                    ...
                    e && (e.classList.remove("waifu-active"),
                    setTimeout(( () => {
    ...
    registerTools() {
        ...
        for (const t of this.config.tools)
            if (this.tools[t]) {
                ...
                i.id = `waifu-tool-${t}`,
                i.innerHTML = s,
                null === (e = document.getElementById("waifu-tool")) || void 0 === e || e.insertAdjacentElement("beforeend", i),
...
async function r(t) {
    ...
    if (t.waifuPath) {
        ...
        function(t) {
            ...
            t.seasons.forEach(( ({date: t, text: s}) => {
                const o = new Date
                  , i = t.split("-")[0]
                  , l = t.split("-")[1] || i;
                Number(i.split("/")[0]) <= o.getMonth() + 1 && o.getMonth() + 1 <= Number(l.split("/")[0]) && Number(i.split("/")[1]) <= o.getDate() && o.getDate() <= Number(l.split("/")[1]) && (s = (s = e(s)).replace("{year}", String(o.getFullYear())),
                n.push(s))
            }
            )),
        ...
        i(function(e, t, s) {
            ...
            if ("" !== document.referrer) {
                ...
                return location.hostname === e.hostname ? o : `${n(s, e.hostname)}<br>${o}`
            }
            return o
    ...
    t.drag && function() {
        ...
        e.addEventListener("touchstart", (n => {
            ...
            const touch = n.touches[0];
            // 计算触摸点相对于看板娘容器左上角的偏移量
            const rect = e.getBoundingClientRect();
            const a = touch.clientX - rect.left;
            const c = touch.clientY - rect.top;

            const handleTouchMove = (event) => {
                const moveTouch = event.touches[0];
                let r = moveTouch.clientX - a;
                let m = moveTouch.clientY - c;
    ...
    if (waifuEl) {
        const waifu_top = window.innerHeight - 250;
        ...
        animation.onfinish = () => {
            waifuEl.style.top = waifu_top + "px";
        };
    }
}
window.initWidget = function(e) {
    if ("string" == typeof e)
        return void a.error("Your config for Live2D initWidget is outdated. Please refer to https://github.com/stevenjoezhang/live2d-widget/blob/master/dist/autoload.js");
    ...
    null == t || t.addEventListener("click", ( () => {
        ...
        (null == t ? void 0 : t.getAttribute("first-time")) ? (r(e),
        null == t || t.removeAttribute("first-time")) : (localStorage.removeItem("waifu-display"),
        null === (s = document.getElementById("waifu")) || void 0 === s || s.classList.remove("waifu-hidden"),
        setTimeout(( () => {
            var e;
    ...
    localStorage.getItem("waifu-display") && Date.now() - Number(localStorage.getItem("waifu-display")) <= 864e5 ? (null == t || t.setAttribute("first-time", "true"),
    setTimeout(( () => {
        null == t || t.classList.add("waifu-toggle-active")
    }
    ), 0)) : r(e)
